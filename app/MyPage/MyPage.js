                            ...
                            <div className='col s4 offset-s4'>
                                  ...
                                  <div className='row'>
                                      ...
                                      <div className='card-panel col s8'>
                                          {teamdata
                                              .filter((team) => team.leaderId === sessionStorage.getItem('id'))
                                                  .map((team) => (
                                          ...
                                          {memberdata
                                              .filter((member) => member.uid === sessionStorage.getItem('id'))
                                                  .map((member) => {
                                                      const team = teamdata.find((team) => team.team_id === member.tid);
                                                          if (team) {
                                                              return (
                                                                    <div key={team.team_id}>
                                                                      {team.name}
